...
vm.alldata.forEach(function (obj)
	...
	var res = alasql("SELECT pantherID,firstName,lastName,email,project,semester,department,college,skillItem,vipcredit,volunteer,independentstudy,rank,userType INTO XLSX('"+todays+"Report.xlsx',{headers:true}) FROM ? ", [nArray]);
